...
| 4.15 | Service Grid Card Styles — add `cardVariant` (compact/detailed) mirroring Service Listing | ✅ Code selesai · tsc clean · ⏳ visual verify | [phase-4.15-service-grid-card-styles.md](phases/phase-4.15-service-grid-card-styles.md) |
